  ...
  return (
    <div className="pb-10" id="contacts">
        ...
        <div className="flex items-center justify-center gap-6 text-2xl">
                ...
                <a
                  href="https://github.com/Dikoii"
                  className="group relative transition-all duration-300 hover:text-gray-800"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="GitHub"
                >
                ...
                <a
                  href="https://x.com/Dikoi04"
                  className="group relative transition-all duration-300 hover:text-black"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Twitter"
                >
                ...
                <a
                  href="https://www.instagram.com/dicky.ds_/"
                  className="group relative transition-all duration-300 hover:text-pink-600"
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Instagram"
                >
        ...
        className="my-4 text-center tracking-tighter">
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=dicky.susanto@binus.ac.id" 
            target="_blank" 
            rel="noopener noreferrer" 
